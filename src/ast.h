...
enum AstTag {
  ...
  AST_EQUAL_EXPRESSION,
  AST_NOT_EQUAL_EXPRESSION,
  AST_AND_EXPRESSION,
...
typedef struct AstEqualExpression* AstEqualExpressionRef;
typedef struct AstNotEqualExpression* AstNotEqualExpressionRef;
