...
AstRef ast_make_struct_declaration_list(AstRef struct_declaration_list, AstRef struct_declaration);
AstRef ast_make_struct_declaration(AstRef specifier_qualifier_list, AstRef struct_declarator_list);
AstRef ast_make_specifier_qualifier_list(AstRef specifier_qualifier, AstRef specifier_qualifier_list);
...
AstRef ast_make_bit_field_declarator(AstRef declarator, AstRef bit_field_declarator);
...
AstRef ast_make_enumerator(AstRef enumeration_constant, AstRef constant_expression);
