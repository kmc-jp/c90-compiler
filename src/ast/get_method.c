...
DEFINE_AST_GET_METHOD(if_statement, IfStatement)
DEFINE_AST_GET_METHOD(if_else_statement, IfElseStatement)
DEFINE_AST_GET_METHOD(switch_statement, SwitchStatement)
DEFINE_AST_GET_METHOD(iteration_statement, IterationStatement)
DEFINE_AST_GET_METHOD(while_statement, WhileStatement)
DEFINE_AST_GET_METHOD(do_while_statement, DoWhileStatement)
DEFINE_AST_GET_METHOD(for_statement, ForStatement)
