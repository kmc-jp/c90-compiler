...
DEFINE_AST_GET_METHOD(less_expression, LessExpression)
DEFINE_AST_GET_METHOD(greater_expression, GreaterExpression)
DEFINE_AST_GET_METHOD(less_or_equal_expression, LessOrEqualExpression)
DEFINE_AST_GET_METHOD(greater_or_equal_expression, GreaterOrEqualExpression)
