...
bool ast_is_less_expression(AstRef ast);
bool ast_is_greater_expression(AstRef ast);
bool ast_is_less_or_equal_expression(AstRef ast);
bool ast_is_greater_or_equal_expression(AstRef ast);
