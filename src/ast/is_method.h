...
bool ast_is_if_statement(AstRef ast);
bool ast_is_if_else_statement(AstRef ast);
bool ast_is_switch_statement(AstRef ast);
bool ast_is_iteration_statement(AstRef ast);
bool ast_is_while_statement(AstRef ast);
bool ast_is_do_while_statement(AstRef ast);
bool ast_is_for_statement(AstRef ast);
