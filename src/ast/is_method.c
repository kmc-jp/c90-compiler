...
DEFINE_AST_IS_METHOD(simple_assignment_expression, SIMPLE_ASSIGNMENT_EXPRESSION)
...
DEFINE_AST_IS_METHOD(and_assignment_expression, AND_ASSIGNMENT_EXPRESSION)
DEFINE_AST_IS_METHOD(xor_assignment_expression, XOR_ASSIGNMENT_EXPRESSION)
DEFINE_AST_IS_METHOD(or_assignment_expression, OR_ASSIGNMENT_EXPRESSION)
