...
DEFINE_AST_IS_METHOD(less_expression, LESS_EXPRESSION)
DEFINE_AST_IS_METHOD(greater_expression, GREATER_EXPRESSION)
DEFINE_AST_IS_METHOD(less_or_equal_expression, LESS_OR_EQUAL_EXPRESSION)
DEFINE_AST_IS_METHOD(greater_or_equal_expression, GREATER_OR_EQUAL_EXPRESSION)
