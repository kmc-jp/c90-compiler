...
AstLessExpressionRef ast_get_less_expression(AstRef ast);
AstGreaterExpressionRef ast_get_greater_expression(AstRef ast);
AstLessOrEqualExpressionRef ast_get_less_or_equal_expression(AstRef ast);
AstGreaterOrEqualExpressionRef ast_get_greater_or_equal_expression(AstRef ast);
