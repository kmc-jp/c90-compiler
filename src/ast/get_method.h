...
AstSimpleAssignmentExpressionRef ast_get_simple_assignment_expression(AstRef ast);
...
AstAndAssignmentExpressionRef ast_get_and_assignment_expression(AstRef ast);
AstXorAssignmentExpressionRef ast_get_xor_assignment_expression(AstRef ast);
AstOrAssignmentExpressionRef ast_get_or_assignment_expression(AstRef ast);
